...
**설명** PDF에서 뽑은 725문항이 세션 하나가 되고, 어디까지 풀었는지가 남습니다

### 업로드

**파일** ./screens/02-upload.png
**설명** PDF를 얹고 세션 이름만 붙이면 준비가 끝납니다

### 문제 풀이

**파일** ./screens/04-study.png
**설명** 한 문제와 보기 네 개만 남기고 나머지는 치웁니다

### 채점

**파일** ./screens/06-wrong.png
**설명** 내가 고른 보기는 빨강, 정답은 초록으로 같이 켜집니다

### 복습

**파일** ./screens/07-review.png
**설명** 오늘 밀린 분량과 오답·북마크·건너뛴 문제를 세션별로 모읍니다

### 복습 채점

**파일** ./screens/09-review-graded.png
**설명** 다음에 이 문제를 언제 다시 볼지 그 자리에서 알려줍니다

## 기획

**문제** 자격증 덤프는 PDF로만 있어서 폰으로 확대해 보기도 불편하고, 어디까지 봤는지가 안 남습니다
**타겟** 덤프 PDF로 자격증을 준비하는 사람이요. 사실은 저 혼자 쓰려고 만든 도구예요
**해법** PDF에서 문항·보기·정답을 뽑아 한 문제씩 카드로 풀게 하고, 어디까지 풀었는지를 서버에 남깁니다
**범위** 로그인은 안 넣었어요. 혼자 쓰는 도구라 계정이 붙는 순간 만들 게 두 배가 됩니다

## 구상

- PDF를 올리면 문항이 알아서 뽑힌다
- 한 문제씩 카드로 풀고 그 자리에서 정답을 본다
- 어디까지 풀었는지가 남아서 다음에 이어 푼다
- 틀린 문제와 북마크만 모아 다시 푼다
- 스캔본 PDF도 OCR로 읽어 낸다
