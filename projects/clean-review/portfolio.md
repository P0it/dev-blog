...
**사용자** 지역에 업종을 붙여 검색해 놓고 블로그 목록을 빠르게 훑어 내려가는 사람이요
...
표시 규칙도 여기서 정했어요. **내돈내산 도장은 안 찍기로 했습니다.** 협찬으로 확인된 것만 덮고, 표시가 없다고 깨끗한 글이라고 말하지 않아요. 놓치는 건 감수해도 멀쩡한 글을 협찬으로 모는 건 안 된다고 봤거든요. 그래서 애매하면 표시하지 않습니다.
