...
**파일** ./screens/01-home.mp4
**설명** 검색창 하나. 워드마크를 두 번 닦아 내고 나면 검색어 예시가 위에서 내려온다

### 확인 중

**파일** ./screens/02-checking.png
**설명** 글을 하나씩 열어 보는 동안 글자를 빛이 훑고 지나간다

### 검색 결과

**파일** ./screens/03-results.png
**설명** 협찬으로 확인된 글은 흐려지고 그 위에 표시가 뜬다

### 업체 확인

**파일** ./screens/04-revealed.png
**설명** 눌러서 흐림을 풀면 어느 체험단 업체인지 나온다

### 협찬 숨기기

**파일** ./screens/05-hidden.png
**설명** 켜면 협찬글이 목록에서 아예 빠진다

### 더 보기

**파일** ./screens/06-more.png
**설명** 30건씩 이어 붙인다. 다 보면 몇 건을 확인했는지 알려 준다

### 웹과 폰

**파일** ./screens/07-both.png
