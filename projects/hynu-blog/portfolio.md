...
**설명** 최근 글이 카테고리·태그와 함께 한 줄씩 깔립니다

### 글 상세

**파일** ./screens/02-post.png
**설명** 커버 위에 제목이 얹히고 목차가 본문을 따라 붙습니다

### 아카이브

**파일** ./screens/03-archive.png
**설명** 쌓인 글 전부를 카테고리로 좁혀 가며 봅니다

### 실험실

**파일** ./screens/04-lab.png
**설명** 만든 프로젝트를 화면 표본처럼 네 장씩 늘어놓습니다

### 프로젝트 상세

**파일** ./screens/05-lab-detail.png
**설명** 원고 한 장이 섹션별 전용 화면으로 펼쳐집니다

### 글 관리

**파일** ./screens/07-admin-posts.png
**설명** 작성중인 글을 위에 두고 상태별로 훑습니다

### 에디터

**파일** ./screens/08-admin-editor.png
**설명** 왼쪽에 마크다운, 오른쪽에 발행 화면과 똑같은 미리보기가 섭니다

### 실험실 관리

**파일** ./screens/09-admin-projects.png
**설명** 프로젝트를 발행 전에 감춰 두고 미리 봅니다

### 통계

**파일** ./screens/10-admin-stats.png
**설명** 어떤 글이 실제로 읽히는지 글별로 셉니다
...
**문제** 기존 블로그 플랫폼은 커뮤니티 기능 위주라, 혼자 기록만 쌓는 데는 안 쓸 화면이 대부분이었어요
**타겟** 쓰는 쪽은 저 혼자고, 읽는 쪽은 검색으로 들어오는 사람들이에요
**해법** 읽는 화면부터 어드민·에디터·통계까지 직접 세워서, 필요한 것만 붙여 나갑니다
**범위** 회원가입도 좋아요도 댓글도 없어요. 읽고 가는 자리라 거기까지는 안 갑니다

## 구상

- 디자인 시안 아홉 장을 실제로 도는 화면으로 옮긴다
- 글을 DB에 두고 어드민에서 쓰고 고친다
- 영상·문서에서 인용할 자료와 장면을 모아 오는 일을 자동화한다
