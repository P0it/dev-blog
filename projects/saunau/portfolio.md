...
**설명** 주변·테마·종류별 입구를 한 화면에 모았다

### 지도

**파일** ./screens/02-map.png
**설명** 지역별 개수로 묶어 보여주고, 칩으로 종류를 거른다

### 매장 상세

**파일** ./screens/03-detail.png
**설명** 영업시간·요금표·후기·메모가 한 화면에 들어온다

### 읽을거리

**파일** ./screens/04-feed.png
**설명** 사우나 문화·이용법을 다룬 읽을거리를 모아 둔다
...
**넣지 않은 것** 로그인. 디바이스 식별로 충분하다고 봤는데, 이건 나중에 뒤집었어요
**넣지 않은 것** 자유 텍스트 리뷰·사진 업로드. 모더레이션을 감당할 사람이 없어요 (사진만 나중에 열었습니다)
