...
**설명** 오늘 촉매가 붙은 국내 종목을 순위로 훑습니다

### 해외

**파일** ./screens/02-foreign.png
**설명** 같은 형식으로 미국 종목과 관련 ETF를 봅니다

### 실적

**파일** ./screens/03-picks.png
**설명** 지난 픽의 진입가 대비 수익률이 날짜별로 쌓입니다

### 발굴

**파일** ./screens/04-discovery.png
**설명** 사건 없이 재무만 보고 뽑은 종목을 점수순으로 봅니다
...
**문제** 언론사를 거친 보도자료는 두 발 늦어요. 손에 들어올 때는 기대가 주가에 이미 반영돼 있습니다
**타겟** 저 혼자 씁니다. 출근길 지하철에서 3분 정도, 폰으로 훑어요
**해법** 기자들이 받아 쓰는 원본(DART·EDGAR)을 직접 받아 점수로 거르고, 사건이 붙은 종목만 카드 몇 장으로 남깁니다
