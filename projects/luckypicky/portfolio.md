...
**문제** 운은 문득 찾아오기만 하는 수동적인 것으로 여겨져요. 능동적으로 쌓을 방법이 없었습니다
**타겟** 2030 여성이요. 하루에 한두 번 잠깐 들어와 한 줄 적고 나가는 쪽입니다
**해법** 선행 한 줄을 잎 하나로 바꿔서, 네 장이 모이면 네잎클로버가 되는 방식으로 운을 눈에 보이게 쌓습니다
**범위** 중국어는 뺐어요. 간체·번체가 갈리고 본토 스토어는 심사와 퍼블리셔가 따로라, 혼자 감당할 운영비가 아니라서요
**제약** 작업 PC 가 윈도우라 iOS 는 코드만 맞춰 두고 빌드 검증을 못 해요. 화면 확인은 전부 안드로이드 에뮬레이터에서 합니다
**정책** 계정은 익명 로그인으로 시작하고, 기기를 옮길 때는 복구 코드로 받기로 했어요
