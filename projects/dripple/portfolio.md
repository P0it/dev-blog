...
**설명** 혼자 배우거나, AI와 붙거나, 방 코드로 친구를 부릅니다
...
**계기** 어렸을 적 아버지가 영어학원을 하셨는데, 거기서 이 카드 게임을 했어요. 그때는 아버지가 보드지를 잘라서 카드를 직접 만들어 보드게임처럼 돌렸습니다. 그게 재밌었던 기억이 남아 있어서, 앱으로 만들어 보고 싶었어요.
...
아버지가 잘라 쓰던 카드를 그대로 옮기는 게 출발이었어요. Flutter로 앱 껍데기를 세우고, 카드를 끌어 옮기는 부분은 Flame에 맡겼습니다. 문법 판정은 처음엔 문장 템플릿 목록을 두고 손패가 그중 하나에 맞는지 보는 방식이었어요. 캐릭터 리액션, 이모트, 효과음 21종, 진동까지 붙여서 한 바퀴는 돌렸습니다.
