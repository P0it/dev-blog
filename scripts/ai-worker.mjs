...
- GitHub 저장소 링크면 WebFetch로 저장소 페이지를 읽으세요 — README·스타
  수·작성자·주 언어가 표시됩니다. README 전문이 필요하면
  raw.githubusercontent.com의 README도 가져오세요. 이때는 규약 "GitHub 저장소
  소개 글" 절의 골격을 따라, 저장소를 한국 독자에게 소개하는 글을 쓰세요.
  README에 적힌 내용을 근거로 하고, 없는 기능·수치는 창작하지 않습니다.
